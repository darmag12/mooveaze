      ...
      <div className="user-log-in">
        <div className="user-log-in-container">
          <header className="user-log-in-container-header">
            <h1 className="user-log-in-container-header__logo">
              <em>MOOVEAZE</em>
            </h1>
            <h1 className="user-log-in-container-header__title">Log In</h1>
            <h2 className="user-log-in-container-header__name">Mooveaze</h2>
          </header>

          <div className="user-log-in-container-content">
            <a
              href={`https://www.themoviedb.org/authenticate/${this.props.requestToken.request_token}?redirect_to=https://www.mooveaze.cf/profile/approved`}
            >
              <button
