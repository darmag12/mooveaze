    ...
    <footer className="main-footer">
      ...
      <section className="main-footer-top">
        ...
        <header className="main-footer-top-header">
          <h2 className="main-footer-top-header__title wow fadeInLeft" data-wow-delay=".5s" data-wow-duration="1.2s">MOOVEAZE</h2>
        ...
        <div className="main-footer-top-item">
          ...
          <p><a href="https://www.dartechx.com/" target="_blank" rel="noopener noreferrer">www.dartechx.com</a></p>
        </div>
        ...
        <p className="main-footer-top-copyright">Copyright &copy;2019<br /> Code and design by <a href="https://www.dartechx.com/" target="_blank" rel="noopener noreferrer">Daryl Magera</a></p>
